...
describe('userRoute', () => {
  ...
  it('should create a new user for order test and retrieve it back', async () => {
    const user = {
      username: 'OrderUser',
      firstName: 'Order',
      lastName: 'User',
  ...
  it('it should not return orders because offset is higher than the size of the orders array', async () => {
    return chai
      .request(app)
